[![.github/workflows/ci-build.yaml](https://github.com/harshitdeka/devops-capstone-project/actions/workflows/ci-build.yaml/badge.svg)](https://github.com/harshitdeka/devops-capstone-project/actions/workflows/ci-build.yaml)
...
└── tests                       <- folder for all of the tests
    ...
    ├── test\_cli\_commands.py    <- CLI tests
    ├── test\_models.py          <- model unit tests
    └── test\_routes.py          <- route unit tests
```
Data Model
